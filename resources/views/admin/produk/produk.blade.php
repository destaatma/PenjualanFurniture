                        ...
                        <form>
                            <div class="row justify-content-center">
                                ...
                                <div class="mb-2 col-11">
                                    ...
                                    <textarea class="form-control form-control-sm" id="produkDeskripsi" name="produkDeskripsi" rows="2" required></textarea>
                                </div>
                            ...
                            <table class="table table-striped table-hover table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>Rp 1.750.000</td>
                                        <td><img src="/beranda/assets/images/product-1.jpg" class="img-thumbnail"
                                                width="80">
                                        </td>
                                        <td>
                                            <div class="d-flex gap-2">
