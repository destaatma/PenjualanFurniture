...
@section('content')
    <main>
        <div class="container-fluid px-4">
            ...
            <a href="{{ route('admin.transaksi.detail_pemesanan.create') }}" class="btn btn-warning mb-3 col-mb-3">
                <i class="fas fa-plus-circle"></i> Tambah Detail
            </a>
            <a href="{{ route('admin.transaksi.pemesanan.index') }}" class="btn btn-secondary mb-3 col-mb-3">Kembali</a>
            <div class="card mb-4">
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('admin.transaksi.detail_pemesanan.destroy', $d->id) }}"
                                                ...
                                                <button type="submit" class="btn btn-danger btn-sm"
                                                    onclick="return confirm('Apakah Anda yakin ingin menghapus detail pemesanan ini?')">
