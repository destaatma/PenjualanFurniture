    ...
    <div class="container">
        ...
        <div class="row mb-4">
            <div class="col-12">
                    <div class="row text-center">
                        ...
                        <div class="col-md-3 col-sm-4 col-6 mb-2">
                            <button class="btn btn-light btn-sm w-100 filter-btn" data-filter="sofa">Sofa</button>
                        </div>
                        <div class="col-md-3 col-sm-4 col-6 mb-2">
                        ...
                        <div class="col-md-3 col-sm-4 col-6 mb-2">
                            <button class="btn btn-light btn-sm w-100 filter-btn" data-filter="rak">Rak Buku</button>
                        </div>
                        <div class="col-md-3 col-sm-4 col-6 mb-2">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 mb-4 produk-item tempat-tidur">
                <div class="text-center p-3 shadow-sm rounded bg-light">
                    <img src="{{ url('/beranda/assets/images/product-4.png') }}" class="img-fluid mb-3 rounded">
            ...
            <div class="col-lg-4 col-md-6 mb-4 produk-item rak">
                <div class="text-center p-3 shadow-sm rounded bg-light">
                    <img src="{{ url('/beranda/assets/images/product-5.png') }}" class="img-fluid mb-3 rounded">
